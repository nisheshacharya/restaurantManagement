...
export async function getFood(token) {
  try {
    const response = await fetch(`${baseURL}/restaurants/${resturantId}`, {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${token}`,
      },
...
export async function addFood(newFood, token) {
  try {
    ...
    const response = await fetch(`${baseURL}/restaurants/${resturantId}/foods`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
...
export async function editFood(newFood, token) {
  try {
    const response = await fetch(`${baseURL}/restaurants/${resturantId}/foods/${newFood._id}`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
...
export async function deleteFood(id, token) {
  try {
    const response = await fetch(`${baseURL}/restaurants/${resturantId}/foods/${id}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${token}`,
      },
...
export async function CheckoutItem(id, token) {
  try {
    const response = await fetch(`${baseURL}/restaurants/${resturantId}/cart/${id}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${token}`,
      },
...
export async function addToCart(newFood, token) {
  try {
    ...
    const response = await fetch(`${baseURL}/restaurants/${resturantId}/cart`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
...
export async function addNotes(newNote, token) {
  try {
    ...
    const response = await fetch(`${baseURL}/restaurants/${resturantId}/notes`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
